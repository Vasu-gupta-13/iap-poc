...
import 'package:in_app_purchase_poc/utils/consumable_store.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title:_usernameLoading ?CircularProgressIndicator() : Text('Username: $username'),
          actions: [
            ElevatedButton(onPressed: (){
              setState(() {
                AuthFunctions().signOut().then((value) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder)=>LoginPage())));
              });
